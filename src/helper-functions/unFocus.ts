...
const isActiveElementSelectedWithTab = () => {
	...
	return (document.activeElement instanceof HTMLElement && document.activeElement.matches("*:focus-visible"));
} 
...
const unFocus = () => {
	...
	if (document.activeElement instanceof HTMLElement && !isActiveElementSelectedWithTab())
