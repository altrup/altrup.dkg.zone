	...
	return (
		<Element id={styles["projects-page"]} name="projects">
			<div className={transitionStyles["interactive"]}>
				...
				<p id={styles["projects-description"]} className={transitionStyles["interactive"]}>Well documented projects that I think are pretty cool</p>
				<div id={styles["projects-div"]}>
					<Project name="Schmek" description="A multiplayer snake game with abilities" 
					...
					<Project name="Soldier Tycoon" description="One of my first games! A one file monstrocity filled with a cringe 8th grade good student agreement" 
