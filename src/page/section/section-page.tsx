										...
										section.description.map((desc, index) => (
											<span key={index}>
												{typeof desc === "string" ? desc :
													<a className={[transitionStyles["interactive"], transitionStyles["clickable"], transitionStyles["rounded-square"]].join(' ')}
														target="_blank" rel="noreferrer" href={desc.href}>{desc.text}</a>}
											</span>
										))
								}</p>
								: undefined}
