...
function ContactsPage() {
  const interactiveClass = useMemo(
    () => [styles["interactive"], transitionStyles["interactive"]].join(" "),
    [],
  );
  const clickableInteractiveClass = useMemo(
    () => [interactiveClass, transitionStyles["clickable"]].join(" "),
    [interactiveClass],
  );
  return (
    <Element id={styles["contacts-page"]} name="contacts">
      <div className={interactiveClass}>
        ...
        <div id={styles["contacts"]} className={interactiveClass}>
          <a
            href="mailto:altrup@dkg.zone"
            className={clickableInteractiveClass}
          >
            altrup@dkg.zone
          </a>
          <a
            href="mailto:eric.liu4@uwaterloo.ca"
            className={clickableInteractiveClass}
          >
            eric.liu4@uwaterloo.ca
          </a>
          <a
            href="https://www.linkedin.com/in/altrup/"
            target="_blank"
            className={clickableInteractiveClass}
            rel="noreferrer"
          >
